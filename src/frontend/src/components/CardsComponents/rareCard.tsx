...
export default function RareCard({ cardData }: dataType) {
    ...
    return (
        <div className=" flex items-center justify-center card-wrapper w-[80%] h-[65%] rounded-md">
            ...
            <div className="card-content flex items-center justify-center bg-indigo-50/[0.3] w-full h-full border border-gray-300 rounded-md bg-white">
                <div className="w-[90%] h-[93%] bg-gradient-to-tl from-indigo-800 to-indigo-900 rounded-md p-3 relative flex flex-col gap-1">
